...
//TODO: uncomment everything and test when trips within trips has been merged in.
...
//
//  public PingMapNotifier(PingMapFrame pingMapFrame, TripNode tripNode) {
...
//      if (this.connectedUserMap.containsValue(currentUser) && !user.equals(currentUser)) {
