...
alter table trip_user_role drop foreign key fk_trip_user_role_user_user_id;
drop index ix_trip_user_role_user_user_id on trip_user_role;

alter table trip_user_role drop foreign key fk_trip_user_role_trip_trip_node_id;
drop index ix_trip_user_role_trip_trip_node_id on trip_user_role;

alter table trip_user_role drop foreign key fk_trip_user_role_role_role_id;
drop index ix_trip_user_role_role_role_id on trip_user_role;
