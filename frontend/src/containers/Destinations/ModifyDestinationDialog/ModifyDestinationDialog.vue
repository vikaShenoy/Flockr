          ...
          <v-flex grid-list>
            ...
            >
              ...
              <v-switch
                ...
                label="Set to public"
                v-if="editMode"
                v-model="editedDestination.isPublic"
              ></v-switch>
            </v-flex>
      ...
      if (this.isValidForm) {
        ...
        if (!this.editMode) {
          destinationInfo = {
            ...
            destinationTypeId: this.destination.destinationType
              .destinationTypeId,
          ...
          destinationInfo = {
            ...
            destinationTypeId: this.editedDestination.destinationType
              .destinationTypeId,
        ...
        if (!this.editMode) {
          ...
          try {
            await sendUpdateDestination(
              destinationInfo,
              this.editedDestination.destinationId
            );
