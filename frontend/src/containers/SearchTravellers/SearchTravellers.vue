                ...
                >
                    <template v-slot:items="props">
                        ...
                        <td class="text-xs-left">
                            <v-chip class="table-chip" v-for="nationality in props.item.nationalities" v-bind:key="nationality">{{ nationality }}</v-chip>
                        </td>
                        <td class="text-xs-left">
                            <v-chip class="table-chip" v-for="type in props.item.travellerTypes" v-bind:key="type">{{ type }}</v-chip></td>
                    </template>
                </v-data-table>
            </v-card>
        </div>
