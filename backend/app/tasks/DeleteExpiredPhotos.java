...
public class DeleteExpiredPhotos {
    ...
    /**
     * Async function to get a list of all expired & deleted personal photos in the database.
     *
     * @return the list of expired deleted photos.
     */
    private CompletionStage<List<PersonalPhoto>> getDeletedPersonalPhotos() {
        return supplyAsync(() -> {
