...
public class TripController extends Controller {
    ...
    @Inject
    public TripController(TripRepository tripRepository, HttpExecutionContext httpExecutionContext, TripUtil tripUtil, Security security, UserRepository userRepository) {
